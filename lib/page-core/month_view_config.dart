...
enum MonthViewConfigType { single, multi, range }

class MonthViewConfig {
  MonthViewConfig({
    MonthViewConfigType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
  ...
  })  : calendarType = calendarType ?? MonthViewConfigType.multi,
  ...
  final MonthViewConfigType calendarType;
...
class CalendarDatePicker2WithActionButtonsConfig extends MonthViewConfig {
